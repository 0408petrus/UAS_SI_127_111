...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="admin">Sistem Informasi IKLC</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?=base_url('datamahasiswa3'); ?>" >
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Data Mahasiswa KOM-C Laboratorium 6
                            </div>
                            <div class="card-body">
				...
				<tr> 
					...
					<td><a href="<?php echo base_url('datamahasiswa3/edit_data/'.$mahasiswa['id_mhs']); ?>">Edit</td>
					<td><a href="<?php echo base_url('datamahasiswa3/delete_data/'.$mahasiswa['id_mhs']); ?>">Delete</td>
					<td><a href="<?php echo base_url('datamahasiswa3/add_data'); ?>">Insert</a></td>
				</tr>
				<?php } ?>
			</tbody>
