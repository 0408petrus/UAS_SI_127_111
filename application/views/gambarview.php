...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Sistem Informasi IKLC</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Kartu Praktikan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Informasi Kartu</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Data Kartu Praktikan Laboratorium 6
                            </div>
                            <div class="card-body">
...
<a href="<?php echo base_url("index.php/gambar/tambah"); ?>">Tambah Gambar</a><br><br>
    ...
    if( ! empty($gambar)) {
        ...
        echo "<tr>";
        echo "<td><img src='".base_url("images/".$data->nama_file)."'
