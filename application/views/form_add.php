...
<table align="center">
<form method="post" action="<?php echo base_url('datamahasiswa3/insert'); ?>">
    <tr>
        <td>Nama</td>
        <td>:</td>
    ...
    <tr>
        <td>NIM</td>
        <td>:</td>
        <td><input type="text" name="nim_mhs" placeholder="Masukkan NIM Anda"></td> 
    </tr>
    <tr>
        <td>KOM</td>
        <td>:</td>
        <td><input type="text" name="kom" placeholder="Masukkan KOM Anda"></td> 
    </tr>
    <tr>
        <td></td>
        <td></td>
