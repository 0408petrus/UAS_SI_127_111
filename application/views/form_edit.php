...
<table align="center">
<form method="post" action="<?php echo base_url('datamahasiswa3/update_data'); ?>">
    <tr>
        <td></td>
        <td></td>
    ...
    <tr>
        <td>Nama</td>
        <td>:</td>
        <td><input type="text" required name="nama_mhs" value="<?php echo $nama_mhs; ?>"></td> 
    </tr>
    <tr>
        <td>NIM</td>
        <td>:</td>
        <td><input type="text" required name="nim_mhs" value="<?php echo $nim_mhs; ?>"></td> 
    </tr>
    <tr>
        <td>KOM</td>
        <td>:</td>
        <td><input type="text" required name="kom" value="<?php echo $kom; ?>"></td> 
    </tr>
    <tr>
        <td></td>
        <td></td>
